...
--                   euclidean ring (i.e. a ring with division; this
--                   allows for *reduction* of fractions)
...
generic                    --  to be provided:
  ...
  with function "-" (a : ring_elt) return ring_elt;     --  unary operator
  with function "+" (a, b : ring_elt) return ring_elt;  --  binary operator
...
package Frac_Euclid is
  ...
  function "+" (f : frac_elt) return frac_elt;              --  unary operator
  function "-" (f : frac_elt) return frac_elt;

  function "+" (f1, f2 : frac_elt) return frac_elt;         --  binary operator
