...
package body Generic_Random_Functions is
  ...
  function Normal_CDF_Single(x: Real) return Real is
    t, poly, y: Real;
  ...
  end Normal_CDF_Single;
  pragma Unreferenced (Normal_CDF_Single);
  ...
  function Normal_inverse_CDF(y0 : Real) return Real is
