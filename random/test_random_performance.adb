...
procedure Test_random_performance is
  ...
  procedure Test is
    ...
    procedure ANF_Reset is begin Reset(ANF_gen); end;
    function ANF_Random return Real is begin return Real(Random(ANF_gen)); end;
    ...
    procedure U_Reset is begin R_U_Rand.Reset(U_gen); end;
    function U_Random return Real is begin return R_U_Rand.Random(U_gen); end;
    ...
    ----------
    --
    --  package R_K_Rand is new PragmARC.Real_Random_Values(Real, PragmARC.KISS_Random.Generator, PragmARC.KISS_Random.Raw);
    ...
    --------------
    --
    --  package R_T_Rand is new PragmARC.Real_Random_Values(Real, PragmARC.Threefry_Random.Generator, PragmARC.Threefry_Random.Random);
