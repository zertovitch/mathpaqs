...
begin
  if Argument_Count < 2 then
    ...
    Put(o,mx,0); Put(o," x "); Put(o,my,0); Put(o," x "); Put(o,Maxval,0);
    ...
    Put(o,my-1,0); Put(o,", 0.."); Put(o,mx-1,0);
    Put_Line(o,") of Float:=");
    ...
    New_Line(o);
    Put_Line(o,"begin");
    Put_Line(o,"  if x < 0.0 or x > 1.0 or y < 0.0 or y > 1.0 then");
    Put_Line(o,"    return 0.0;");
    Put_Line(o,"  else");
    Put(o,     "    return a( Integer( (1.0-y) * Float(");
    Put(o,my-1,0);Put_Line(o,") ),");
    Put(o,     "              Integer(       x * Float(");
    Put(o,mx-1,0);Put_Line(o,") ) );");
    Put_Line(o,"  end if;");
